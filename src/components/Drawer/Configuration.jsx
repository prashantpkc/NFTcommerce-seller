...
const Configuration = () => {
  ...
  const isSidebarDarkEnabled = useSelector(
    (state) => state.sidebarDarkMode.isSidebarDark
  );
        ...
        <div>
          ...
          <div className="flex justify-between mt-4 mb-8">
            ...
            <div className="h-10 w-36 border cursor-pointer border-[#3520ed] rounded-lg flex justify-center items-center">
              <p
                className="text-[#3520ed] font-semibold"
                onClick={handleSetSidebarDark}
              >
                Dark
              </p>
            </div>
